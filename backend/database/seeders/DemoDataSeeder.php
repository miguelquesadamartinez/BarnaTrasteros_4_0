...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->call(TamanyoTrasteroSeeder::class);
        ...
        $clientesData = [
            ...
            [3,  'Ana',      'Fernández Torres',   '612100003', '33333333C', 'Carrer de Provença, 78',    '08009', 'Barcelona',   true],
            [4,  'Pedro',    'Sánchez Morales',    '612100004', '44444444D', 'Carrer de Balmes, 200',     '08006', 'Barcelona',   true],
            [5,  'Laura',    'López Jiménez',      '612100005', '55555555E', 'Passeig de Gràcia, 55',     '08007', 'Barcelona',   true],
            [6,  'Carlos',   'Rodríguez Blanco',   '612100006', '66666666F', 'Carrer de Muntaner, 88',    '08011', 'Barcelona',   true],
            [7,  'Sofía',    'Gómez Castillo',     '612100007', '77777777G', 'Gran Via de les Corts, 300','08015', 'Barcelona',   true],
            [8,  'Miguel',   'Díaz Herrera',       '612100008', '88888888H', 'Carrer de Còrsega, 412',    '08037', 'Barcelona',   true],
            [9,  'Elena',    'Muñoz Vega',         '612100009', '99999999J', 'Carrer de València, 100',   '08011', 'Barcelona',   true],
            [10, 'Roberto',  'Álvarez Peña',       '612100010', '10101010K', 'Carrer de Rosselló, 230',   '08008', 'Barcelona',   true],
            [11, 'Carmen',   'Romero Iglesias',    '612100011', '11111112L', 'Avinguda del Paral·lel, 14','08001', 'Barcelona',   true],
            [12, 'Javier',   'Navarro Serrano',    '612100012', '12121212M', 'Carrer de Tarragona, 50',   '08015', 'Barcelona',   true],
            [13, 'Lucía',    'Torres Molina',      '612100013', '13131313N', 'Carrer de Sants, 77',       '08014', 'Barcelona',   true],
            [14, 'Antonio',  'Ramos Delgado',      '612100014', '14141414P', 'Carrer de la Marina, 210',  '08005', 'Barcelona',   true],
            [15, 'Cristina', 'Vargas Ortega',      '612100015', '15151515Q', 'Rambla del Poblenou, 30',   '08005', 'Barcelona',   true],
            [16, 'Sergio',   'Mora Campos',        '612100016', '16161616R', null,                        null,    null,          true],
            [17, 'Natalia',  'Reyes Guerrero',     '612100017', '17171717S', null,                        null,    null,          true],
            [18, 'Pablo',    'Giménez Fuentes',    '612100018', '18181818T', null,                        null,    null,          true],
            [19, 'Irene',    'Castro Pedraza',     '612100019', '19191919V', null,                        null,    null,          true],
            [20, 'Marcos',   'Cabrera Mendoza',    '612100020', '20202020W', null,                        null,    null,          true],
        ];
        $clientes = [];
        ...
        $this->command->info('✅ Seeder de datos de demo completado: 20 clientes, 45 pagos, 20 gastos.');
    }
}
